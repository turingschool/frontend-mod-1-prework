for (var i = 10; i >= 1; i--) {
  if (i <= 10 && i > 2) {
    ...
    console.log(i + " speckled frog sat on a log eating some most delicious bugs. One jumped into the pool where its nice and cool, then there were no more speckled frogs!")
  }
};

...
console.log(zooAnimals);   //logs all key value pairs
console.log(zooAnimals.peacocks);  //logs key value
...
*/
var email = {
  sender: 'Kumo@dogworld.com',
  date: 'Tuesday, June 8',
  subject: "Let's play!",
  urgent: true,
  reply: 'Kumo@dogworld.com',
  recipients: 3
}
console.log(email);
//-------------------
...
var email = [
  {
    dateRecieved: 'Tuesday June 8',
    timeRecieved: '11 AM',
    dateRead: 'Wednesday June 9',
    timeRead: '1 PM'
  },
  {
    cc1: 'Sam@dogworld.com',
    cc2: 'Fluffy@dogworld.com',
    cc3: 'Blue@dogworld.com'
  },
  {
    reply1: "I'll be there!",
    reply2: "Sorry can't make it today",
    reply3: "Woof!"
  }
];
console.log(email);

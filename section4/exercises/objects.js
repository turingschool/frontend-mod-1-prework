...
// the Object
console.log(animalsAtZoo.zebra);


// Add an animal to the zoo Object, and log the updated Object.
animalsAtZoo.seaLion = 3;
console.log(animalsAtZoo);

// Change the value for at least one of your animal keys, and log the updated Object.
animalsAtZoo.cobra = 3;
animalsAtZoo.seaLion =4;
console.log(animalsAtZoo);

// Add another animal to the zoo Object, and log the updated Object.
animalsAtZoo.elephant = 5;
console.log(animalsAtZoo);
...
var email = {
  sender: 'Nationwide Pet',
  subject: 'Your insurance for Nalle will expire soon!',
  dateSent: 'May 3, 2021',
  timeSent: '9 AM',
  status: 'unread',
};
...
var emails = [
  {
    sender: 'Nationwide Pet',
    email: 'noreply@email.petinsurance.com',
    subject: 'Your insurance for Nalle will expire soon!',
    dateSent: 'May 3, 2021',
    timeSent: '9 AM',
    status: 'unread',
  },
  {
    ...
    subject: 'You sent a payment of $65.58 USD to Jolyn',
    dateSent: 'May 25, 2021',
    timeSent: '12 PM',
    status: 'read',
  },
  {
    sender: 'Little John',
    email: 'thementalist@cbs.com',
    subject: "Patrick, you can't catch me...",
    dateSent: 'July 12, 2019',
    timeSent: '2 AM',
    status: 'read',
  }
];

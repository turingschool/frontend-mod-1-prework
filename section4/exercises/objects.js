...
zooAnimals.monkeys = 11
console.log(zooAnimals);
// Change the value for at least one of your animal keys, and log the updated Object.
zooAnimals.tigers = 2
console.log(zooAnimals);
// Add another animal to the zoo Object, and log the updated Object.
zooAnimals.capybaras = 4
console.log(zooAnimals);
//-------------------
// Part 2: Email
//-------------------
...
var email = {
  author: 'monshan',
  recipeint: 'damwhit',
  subjectLine: 'Section 4 Greeting',
  cc: 'none',
  body: 'wassup',
  deviceSignature: ' -Sent from my iPhone'
}
...
var readEmails = [
  {
    author: 'monshan@slack.com',
    recipeint: 'damwhit@slack.com',
    subjectLine: 'Section 4 Greeting',
    cc: 'none',
    body: 'wassup',
    deviceSignature: ' -Sent from my iPhone'
  ...
  {
    author: 'sephora@sephora.com',
    recipeint: 'monshan@slack.com',
    subjectLine: 'Season Deals Just for You!',
    cc: 'mailing list',
    body: 'click the link below to access your deals',
    deviceSignature: ' -Sephora Official'
  },
  {
    author: 'jade127@gmail.com',
    recipeint: 'monshan@slack.com',
    subjectLine: 'Section 4 Greeting',
    cc: 'none',
    body: 'Doyoung is coming for me this comeback!',
    deviceSignature: 'Jade Virgil, EPIK Junior Instructor'
  }
]

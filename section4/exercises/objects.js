...
zooAnimalTypes.leopard = 10,
console.log(zooAnimalTypes)
// returns 10

// Add another animal to the zoo Object, and log the updated Object.

zooAnimalTypes.chimpanzee = 4
console.log(zooAnimalTypes)
// returns
// fox: 14,
// leopard: 10,
...
*/
 var emails = {
   sender: "Zara",
   orderNumber: 52373630720,
   delivery: "Express home shipping",
   products: 2,
   followUs: ["Instagram","Facebook","Twitter"]
...
var emails = [{
  sender: "Volo",
  orderNumber: 4567890234,
  delivery: "online",
  products: "Indoor volleybal",
  followUs:["Facebook", "instagram"]
},
{
  sender: "Recreation.gov",
  orderNumber: 037654,
  delivery: "online",
  products: "Camping",
  followUs: ["Facebook", "Instagram"]
...
{
  sender: "Mount Princeton Hot Springs Resort",
  orderNumber: 420720,
  delivery: "online",
  products: "Spa",
  followUs: ["Instagram", "Facebook", "Twitter"]

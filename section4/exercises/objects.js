...
// the Object
console.log(zoo.namePrimate);

// Add an animal to the zoo Object, and log the updated Object.
var zoo = {
  namePrimate: 'monkey',
  quantityPrimate: 10,
  nameArachnid: 'tarantula',
  quantityArachnid: 100,
};
console.log(zoo);

// Change the value for at least one of your animal keys, and log the updated Object.
zoo.quantityPrimate = 12;
...
var email = {
  sender: 'joe@abc.com',
  recipient: 'molly@abcd.com',
  subject: 'You have to see this!',
  body: 'This is a funny cat picture.',
  dateSent: '1/1/2001',
}
console.log(email);
...
{
sender: 'joe@abc.com',
recipient: 'bob@abcd.com',
subject: 'Important!',
body: 'We have a meeting at 5pm.',
dateSent: '1/2/2001',
},
{
sender: 'joe@abc.com',
recipient: 'bob@abcd.com',
subject: 'Meeting time changed to 6pm',
body: 'Please plan accordingly.',
dateSent: '1/2/2001',
}
]


console.log(emailOutbox);

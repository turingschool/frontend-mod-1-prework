...
Object.assign(animals, {giraffes: 2});
console.log(animals);
...
var email = {
  ...
  ccEmails: ["myworkemail@gmail.com", "turingteach@gmail.com"],
  subject: "Read me ASAP",
  numOfCharactersInBody: 120,
  numOfAttachments: 2
}
console.log(email);
...
var emails = [
  ...
  senderEmail: "myemail@gmail.com",
  ccEmails: [],
  subject: "First Paragraph Draft",
  numOfCharactersInBody: 236,
  numOfAttachments: 0
  },
  {
  senderEmail: "tahiringmanager@school.com",
  ccEmails: ["theschooldept@school.com"],
  subject: "My Resume, CV, Cover Letter, and Headshot",
  numOfCharactersInBody: 42,
  numOfAttachments: 4
  }
]
console.log(emails);

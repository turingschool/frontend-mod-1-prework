...
console.log(primates.chimpanzees);

// Add an animal to the zoo Object, and log the updated Object.

primates.orangutans = 2;
console.log(primates);


// Change the value for at least one of your animal keys, and log the updated Object.

primates.gorillas = primates.gorillas - 1;
console.log("We lost a gorilla, now we have " + primates.gorillas + " gorillas.");
// Add another animal to the zoo Object, and log the updated Object.

primates.bonobo = 6;

console.log("Update: we have aquired " + primates.bonobo + " bonobos.");
...
var eMails = [
  {
    sender: "Billy Bragg",
    subject: "I can't say which night",
    attachments: false,
    numberRecipients: 1,
    timeSent: Date()
  },
  {
    sender: "Sebastian Bach",
    subject: "Where arte thou Wolfy?",
    attachments: false,
    numberRecipients: 2,
    timeSent: Date()
  },
  {
    sender: "Brooke Binion",

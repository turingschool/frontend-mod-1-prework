...
// the Object
console.log(animals.animalType);

// Add an animal to the zoo Object, and log the updated Object.
animals.animalType = "Gator";

console.log(animals);

// Change the value for at least one of your animal keys, and log the updated Object.
animals.numberInZoo = 120;

console.log(animals);

// Add another animal to the zoo Object, and log the updated Object.
animals.animalType = "Big ol Birds";
animals.numberInZoo = 120000000;
...
var emails = {
  sender: "Top Chef",
  subject: "You should be the next top chef",
  timeStamp: "8:24 AM July 24, 2020",
  isSpam: false,
  isPriority: true
}
...
var emails = [
  {
    sender: "Padma Lakshmi",
    subject: "Did you like the Colorado Season?",
    timeStamp: "10:32 AM June 10, 2020",
    isSpam: false,
    isPriority: true
  },
  {
    sender: "Tom Colicchio",
    subject: "I'm not cranky, I'm just particular",
    timeStamp: "12:32 PM January 12, 2019",
    isSpam: false,
    isPriority: false
  },
  {
    sender: "Richard Blais",
    subject: "10 Cooking Fads that are Worth the Hype",
    timeStamp: "12:00 AM March 13, 2020",
    isSpam: true,
    isPriority: false
  }
]

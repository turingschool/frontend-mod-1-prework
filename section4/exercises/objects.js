...
console.log(zooAnimals.typeName[0] + " " + zooAnimals.numType[0]);

// Add an animal to the zoo Object, and log the updated Object.

zooAnimals.typeName[3] = "Seal";
zooAnimals.numType[3] = 2;
console.log(zooAnimals);

// Change the value for at least one of your animal keys, and log the updated Object.
zooAnimals.typeName[3] = "Wolf";
zooAnimals.numType[3] = 21;
console.log(zooAnimals);

// Add another animal to the zoo Object, and log the updated Object.
zooAnimals.typeName[4] = "Seal";
zooAnimals.numType[4] = 2;
console.log(zooAnimals);
...
var myEmail = {
  name: "Aaron",
  signIn: true,
  address: "Aaron@123.com",
  contactList: ["Bob", "Erinna", "Amie"],
  numEmails: 55,
};
console.log(myEmail);
...
var email = [
  ...
  },
  {
    ...
    signIn: false,
    address: "Bob@321.com",
    contactList: ["Aaron", "Erinna", "Amie", "Bill"],
    numEmails: 5,
  },
  {
    name: "Erinna",
    signIn: true,
    address: "EMC@123.com",
    contactList: ["Bob", "Aaron", "Amie", "Sue"],
    numEmails: 12324412,
  }
]

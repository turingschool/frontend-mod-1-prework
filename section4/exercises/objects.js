...
// the Object
console.log("There are this many lions:");
...
var email = {
  sender: "Turing School of Softwear and Design",
  subject: "Welcome to Turing!",
  emailContent: "Mod1 starts on November 30th. Get ready!",
  haveOpened: true,
  whenReceived: "4:07PM 10/25/20"
}
...
var emails = [
  //FIRST EMAIL
  {
    sender: "David Whitaker",
    subject: "[cbmackintosh/frontend-mod-1-prework] Add section 2 work (3699da5)",
    emailContent: "@cbmackintosh solid work on this. Holler if you have any questions!",
    haveOpened: true,
    whenReceived: "10/22/20"
  },
  //SECOND EMAIL
  {
  sender: "Colfax Strong",
  subject: "Colfax Chronicles 10/24",
  emailContent: "COLFAX STRONG IN-HOUSE COMP | We all at Colfax Strong have been through a...",
  haveOpened: true,
  whenReceived: "10/24/20"
  },
  //THIRD EMAIL
  {
  sender: "Elfster",
  subject: "Win $100 in Elfster's Pumpkin Carving Contest!",
  emailContent: "Boo-Yah! It's a pumpkin carving contest. Grab your pumpkin...",
  haveOpened: false,
  whenReceived: "10/25/20"
  }
];

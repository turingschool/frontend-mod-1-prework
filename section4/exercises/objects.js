...
animals.lions = 0; //sold all lions to another zoo.
animals.chinchillas = 0; //poor chinchilla died.
...
var email = {
  sender: `shayangolafsh@aol.com`,
  recipient: `erin@turing.io`,
  subject: `Enrollment Date`,
  timeStamp: '1:34 PM March 5, 2021',
  msgBody: 'Hi Erin, can you remind me when the orientation date for mod 2103 is?'
};
...
var emails = [
  ...
  {
    sender: `erin@turing.io`,
    recipient: `shayangolafsh@aol.com`,
    subject: `Enrollment Date`,
    timeStamp: '2:33 PM March 5, 2021',
    msgBody: 'Hi Shayan, your orientation date for 2103 is March 10th, from 9 AM - Noon on zoom. \n Let me know if you have questions.'
  },
  {
    sender: `shayangolafsh@aol.com`,
    recipient: `erin@turing.io`,
    subject: `Enrollment Date`,
    timeStamp: '3:34 PM March 5, 2021',
    msgBody: 'Ah, got it. Thank you so much Erin!'
  },
  {
    sender: `erin@turing.io`,
    recipient: `shayangolafsh@aol.com`,
    subject: `Enrollment Date`,
    timeStamp: '3:44 PM March 5, 2021',
    msgBody: 'No problem, Shayan.'
  }
]
console.log(emails);

...
console.log(animals.caterpillar)
...
var emailInfo = {
  ...
  signature: "From Jahara Clark",
  image: "dayAtThePark.jpg",
  characters: 23435,
  paragraphs: 33
}
...
var emailDescriptor =   [
  {
    image: "partyAllTheTime.jpg",
    characters: 398475,
    paragraphs: 3
  },
  {
    image: "superCuteKids.jpg",
    characters: 2873,
    paragraphs: 11
  },
  {
    image: "girlsJustWannaHaveFun.jpg",
    characters: 8675309,
    paragraphs: 92
  }
]

console.log(emailDescriptor);
console.log(emailDescriptor[0]);
console.log(emailDescriptor[1]);
console.log(emailDescriptor[2]);

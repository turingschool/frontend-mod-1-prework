...
animals.animalName[1] = "giraffe";
animals.numAnimals[1] = 2;

console.log(animals);

// Change the value for at least one of your animal keys, and log the updated Object.
animals.animalName[1] = "hippo";

console.log(animals);

// Add another animal to the zoo Object, and log the updated Object.
animals.animalName.push("gorilla");
animals.numAnimals.push(1);
...
var email = {
  ...
  recipients: ["anotherFakeEmail@gmail.com"],
  subjectLine: "URGENT: Cake Recipe",
  body: "Here is the cake recipe you wanted: fakelink.com.",
  sent: false
};
...
var myEmails = [
  ...
  {
    sender: "fakeEmail@gmail.com",
    recipients: ["thirdFakeEmail@yahoo.com"],
    subjectLine: "Decoration Ideas",
    body: "Hey Jack, I was wondering if you know if Janice has anything she particularly likes-- colors, shows, etc.?",
    sent: true
  },
  {
    sender: "fakeEmail@gmail.com",
    recipients: ["anotherFakeEmail@gmail.com", "thirdFakeEmail@yahoo.com"],
    subjectLine: "Janice's Birthday",
    body: "I can take care of the decorations if Mark can bake the cake this time.",
    sent: true
  }
]

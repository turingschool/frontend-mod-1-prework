...
var youveGotMail = {
  sender: "Janika Hortizuela",
  subject: "Dank Memes",
  message: "Please see attached dank memes",
  emailTo: "buddy.holly@aol.com",
  numberOfAttachments: "12"

}

console.log(youveGotMail);
...
var lotsaEmails = [
  {
    sender: "Dahli Llama",
    subject: "Dankest Memes",
    message: "To view the dankest memes, see attached email",
    emailTo: "llama@dahli.com",
    numberOfAttachments: "92"
  },
  {
    sender: "Seth Rogan",
    subject: "Memes that are dank",
    message: "Please see attached dank memes",
    emailTo: "rogenseth@aol.com",

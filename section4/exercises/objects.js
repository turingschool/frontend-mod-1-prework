...
var emails = {
  sender: "anna",
  recipent: "kyle",
  subject: "Print this please.",
  messageBody: "Hi, please print this at work and bring home with you! Thank you.",
  attachment: "printme.pdf",
  signature: "Anna Johnson"
};
console.log(emails);
...
var emails = ["sender", "recipient", "subject", "messageBody", "attachment", "signature"];
var emails = [
  {
    fromDisplayName: "Anna Johnson",
    fromEmailAddress: "ae.johnson2931@gmail.com"
  },
  {
    toDisplayName: "Kyle Johnson",
    toEmailAddress: "kylerossjohnson@gmail.com"
  }
]
console.log(emails);

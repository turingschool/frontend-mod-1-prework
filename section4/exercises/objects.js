...
var animals = {
  types: ["giraffes", "polar bears", "spider monkeys", "gorillas"],
  giraffes: 3,
  polarBears: 1,
  spiderMonkeys: 13,
  gorillas: 2
...
animals.types.push("warthog");
console.log(animals.types);

// Change the value for at least one of your animal keys, and log the updated Object.
animals.spiderMonkeys = 14;
console.log(animals.spiderMonkeys);

// Add another animal to the zoo Object, and log the updated Object.
animals.types.unshift("penguins");
console.log(animals.types);

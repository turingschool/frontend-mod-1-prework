...
// the Object
console.log(zoo.animal1);

// Add an animal to the zoo Object, and log the updated Object.
zoo.animal3 = 'Penguin';
zoo.numberOfPenguins = 12;
console.log(zoo.animal3);

// Change the value for at least one of your animal keys, and log the updated Object.
zoo.numberOfElephants = 2;
console.log(zoo);

// Add another animal to the zoo Object, and log the updated Object.
zoo.animal4 = 'Mokey';
zoo.numberOfMonkeys = 10;
console.log(zoo);
...
*/
var email = {
  sender: 'partyplanner@gmail.com',
  recipient: 'stevenrmancine@gmail.com',
  subject: 'Surprise pizza party',
  date: 'October 5th, 2020, 7:05 AM',
  body: "Hey, don't forget about the secretp pizza party next friday"
}
console.log(email);
//-------------------
...
var newEmail = [
  {
    sender: 'info@p.backcountry.com',
    recipient: 'stevenrmancine@gmail.com',
    subject: 'New Fall Apparel Built by Backcountry',
    date: 'October 17th, 2020, 5:19 AM',
    body: "Check out our new fall apparel, coming out today"
  },
  {
    sender: 'noreply@apple.com',
    recipient: 'stevenrmancine@gmail.com',
    subject: 'Two-factor authentication enabled for your Apple ID',
    date: 'October 15th, 2020, 3:42 PM',
    body: "Dear steven mancine, two-factor authentication for your apple ID was enabled."
  },
  {
    sender: 'costumerservice@homeagain.com',
    recipient: 'stevenrmancine@gmail.com',
    subject: 'Oni, Welcome Back',
    date: 'October 17th, 2020, 7:05 AM',
    body: "Oni's membership has expired, click here to reactivate now."
  }
];

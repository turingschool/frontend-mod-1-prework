...
var emailInfo = {
  sender: "John Doe",
  recipient: "Sally Mae",
  subjectLine: "Checking In!",
  greeting: "Hey Sally",
  message: "Just wanted to stop by and check in to see how you were doing!",
  closing: "Have a good one, John",
  timestamp: "11:10 AM February 19, 2021"
}
...
var emails = [
  ...
  },
  {
      sender: "Sally Mae",
      recipient: "John Doe",
      subjectLine: "Re: Checking In!",
      greeting: "Hi John",
      message: "Thank you so much! I am great! How are you?",
      closing: "Xoxo, Sally",
      timestamp: "11:21 AM February 19, 2021"
  },
  {
      sender: "Richard Smith",
      recipient: "Derrick Howard",
      subjectLine: "Howdy",
      greeting: "Hi Derrick",
      message: "Hope all is well. Have you checked on that project yet?",
      closing: "Happy Friday, Richard",
      timestamp: "11:35 AM February 19, 2021"
  }
]
...
//not really understanding what the console.log(emails[0]) returns!

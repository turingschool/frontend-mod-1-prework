...
zooAnimals.gorilla = 7;

console.log(zooAnimals);

// Change the value for at least one of your animal keys, and log the updated Object.
 zooAnimals.gorillas = 9;
 console.log(zooAnimals);

// Add another animal to the zoo Object, and log the updated Object.

zooAnimals.peacocks = 11;
console.log(zooAnimals);
...
var email = {
  email: 'gmail',
  subjectLine: 'Return signed document enclosed',
  sender: 'Susanna',
  language: 'English',
  to: 'Melissa',

...
console.log(animals.sharks)

// Change the value for at least one of your animal keys, and log the updated Object.

animals.otters = 7;

console.log(animals.otters);
...
var emails = [
  {
    sender: "Randall White",
    time: "1:15pm",
    subject: "Time Punch Edit",
    body: "Please review attached timesheet for edits",
    sinature: true
  },
  {
    sender: "Taryn Stark",
    time: "9:00am",
    subject: "Let's go to the Mountians!",
    body: "My parent's are letting me use the cabin this weekend! Let's go!",
    sinature: false
  },
  {
    sender: "Hot Yoga Unlimited",
    time: "2:43pm",
    subject: "Want 10 free classes?",
    body: "Sign up for a yearly pass and get 10 free classes!",
    sinature: true
  },
]

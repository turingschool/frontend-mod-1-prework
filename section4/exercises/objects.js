...
var manyEmails = [
  {
    ...
    to: 'myemail@gmail.com',
    subject: 'New email one',
    body: 'Body of the email one',
    signature: 'information sender one',
  },
  {
    from: 'email2@gmail.com',
    to: 'myemail@gmail.com',
    subject: 'New email two',
    body: 'Body of the email two',
    signature: 'information sender two',
  },
  {
    from: 'email3@gmail.com',
    to: 'myemail@gmail.com',
    subject: 'New email three',
    body: 'Body of the email three',
    signature: 'sinformation sender three',
  },
];

...
zooAnimals.hippos = 123;
console.log(zooAnimals);

// Change the value for at least one of your animal keys, and log the updated Object.
zooAnimals.tigers = 12889;
console.log(zooAnimals);

// Add another animal to the zoo Object, and log the updated Object.
zooAnimals.pigeons = "too many to count";
console.log(zooAnimals);
...
var email = {
  from: "scammity@scamscam.com",
  to: "nolancaine@gmail.com",
  cc: "none",
  subject: "We\n've been meaning to contact you about your car\n's extended warranty",
  sentAt: "12:37 AM"
}
...
var emails = [
  ...
  {
    from: "contact@turing.edu",
    to: "8080b7a05247f0dee13a0a26fmc list",
    cc: "nolancaine@gmail.com",
    subject: "Your upcoming appointment is starting in about 10 minutes",
    sentAt: "11:50 AM"
  },
  {
    ...
    to: "nolancaine@gmail.com",
    cc: "none",
    subject: "You have a refund from so-and-so",
    sentAt: "3:49 PM"
  }
]
console.log(emails);

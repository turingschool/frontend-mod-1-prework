...
var lunchOrder = {
  ...
  tableNumber: 47,
  prepare: function() {
    console.log("Build sandwhich from pre-cooked toppings.")
  },
  complete: function() {
    console.log("Wrap sandwhich with napkin on side.")
}
};
...
// Expected Return: 
// Build sandwhich from pre-cooked toppings.
// Wrap sandwhich with napkin on side.

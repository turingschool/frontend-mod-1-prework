...
var lunchOrder = {
  ...
  tableNumber: 47,
  prepare: function() {
    console.log("Your " + lunchOrder.dish + " is being prepared.")
  },
  complete: function() {
    console.log("Your " + lunchOrder.dish + " and " + lunchOrder.beverage + " are being delivered to table " + lunchOrder.tableNumber + ".")
  }
};

...
animals.splice(2,0,'Rhino');
console.log(animals);


// YOU DO: Write code that will log the String "Elephant" in the animals array
//Anywhere?//
newLength = animals.push('Elephant');
console.log(animals);
...
foods.splice(2,0,'sugar', 'cereal', 'almondMilk');
console.log(foods);
...
// 1: Facebook: a list of users' friends
// 2: Spotify: a list of songs on a playlist
// 3: Amazon: a list of items in cart

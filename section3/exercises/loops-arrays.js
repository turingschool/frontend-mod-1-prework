...
var animals = ["Horse", "Cat", "Guinea Pig", "Ardvark", "Rhino", "Donkey"];
...
var foods = ["Naan", "Ketchup", "Seitan", "Cherry Tomatoes", "Cantaloupe", "Salt"];
...
var numbers = ["8", "12", "83", "23", "98", "632", "1823024847"];
...
if (ages[i] <= 17) {
  console.log( (i), "Oh no, you can't vote quite yet.")
} else {
  console.log( (i), "Make sure you get out and vote!")
}

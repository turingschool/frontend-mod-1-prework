...
var animal = [ "alligator", "bear", "cobra", "doggo" ];
...
var toGet = [ "eggs", "flan", "grapes", "hard candy", "ice cream" ];

for ( var i = 0; i < toGet.length; i++ ) {
  console.log( "Add " + toGet[ i ] + " to shopping list" )
}


// YOU DO: Create an array of numbers and then iterate over that array to log double
// of each of the numbers. (Ex: 4 doubled is 8.)

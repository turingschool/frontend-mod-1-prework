...
// YOU DO: Create an array of foods and then iterate over that array to log 'Add <food> to shopping list' for each food item.

var foods = ['peanuts', 'raspberries', 'bread'];

for (var i = 0; i < foods.length; i++) {
  console.log(`Add ${foods[i]} to shopping list`);
}

// YOU DO: Create an array of numbers and then iterate over that array to log double of each of the number. (Ex: 4 doubled is 8.)
...
// YOU DO: Using the array of names below, print out 'Happy Birthday <name>' for each name except the first two.
...
// WORD FROM THE WISE: Before you start coding, jot down, with pen and paper, what steps you want to tell the program to take. Think of all the concepts you've learned so far.

...
var foods = ['mango','pineapple','blueberry','milk'];
...
for (var i = 2; i < nums.length + 2; i++) {
  console.log("Happy Birthday " + names[i]);
}
// Meg - Well, this is probably not the prettiest way, but it worked!
...
// Meg - Wow, that felt like a cool little victory when I pieced it together!

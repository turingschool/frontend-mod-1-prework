...
var foods = ["Peanut butter", "Cheese", "Onions", "Carrots"]
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] === 17) {
    console.log("Can almost vote!")
  } else if (ages[i] === 20) {
    console.log("Can almost drink.")
  } else if (ages[i] === 34) {
    console.log("Mid-thirties")
  } else if (ages[i] === 18) {
    console.log("Can finally vote!")
  } else if (ages[i] === 16) {
    console.log("Sweet sixteen")
  } else if (ages [i] === 65) {
    console.log("Medicade eligable")
  } else if (ages[i] === 49) {
    console.log("Almost 50!")
  } else if (ages[i] === 10) {

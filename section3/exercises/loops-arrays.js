...
var foodList = ["giant slug gut paste","toad milk","hummus"]

for (var i = 0; i < foodList.length; i++) {
  console.log("Add " + foodList[i] + " to the shopping list")
}

// YOU DO: Create an array of numbers and then iterate over that array to log double
// of each of the number. (Ex: 4 doubled is 8.)

var numsToDoub = [1,2,3,4];

for (var i= 0; i < numsToDoub.length; i++) {
  console.log(numsToDoub[i]*2);
}

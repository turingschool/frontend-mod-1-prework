...
for (var animals = 0; animals <= 3; animals++) {
...
var foods = ["pizza", "burger", "soda"];
for (var foods = 0; foods <= 3; foods++); {
 console.log("Add" + foods + "to shopping list");
}

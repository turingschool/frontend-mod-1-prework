...
animals = ['panda', 'lion', 'dragon', 'aardvark'];
for (var i = 0; i < animals.length; i++) {
...
var foods = ['tofu', 'peaches', 'noodles', 'bread', 'guacamole'];
...
// iterate over each ages
  // if it's less than 18, log can't vote message
  // otherwise log vote message

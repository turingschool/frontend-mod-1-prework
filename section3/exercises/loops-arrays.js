...
var foods = ["Potato", "Steak", "Cucumber", "Onion"];
...
names = names.slice(2, 7);

 for(var i = 0; i < names.length; i++) {
   console.log(names[i], "Happy Birthday")
 }
...
for(var i = 0; i < ages.length; i++) {
   if(ages[i] < 18)
   console.log("oh no you cant vote yet")
  else if (ages[i]>=18)
  console.log("get out and vote")
}
*/

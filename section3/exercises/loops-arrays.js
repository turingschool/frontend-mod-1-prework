...
var animals2 = ["Monkey", "Lion", "Elephant", "Bear", "Bird"];

for (var i = 0; i < animals2.length; i++) {
  console.log(animals2[i] + " is awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var foods = ["eggs", "milk", "bread", "onions", "cheese"];
...
var number = [1, 2, 3, 4, 5, 6, 10, 12];

for (var i = 0; i < number.length; i++) {
  console.log(number[i] + " doubled is: " + (number[i] * 2));
}

...
var foodsINeed = ["Tortillas", "Cheese", "Chicken"];

for (var i = 0; i < foodsINeed.length; i++) {
  console.log("Add " + foodsINeed[i] + " to shopping list");
}


// YOU DO: Create an array of numbers and then iterate over that array to log double
// of each of the number. (Ex: 4 doubled is 8.)
var numBunnies = [1, 2, 3, 4];

for(var i = 0; i < numBunnies.length; i++) {
  console.log(numBunnies[i] * 2);
}

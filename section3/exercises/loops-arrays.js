...
ages.forEach(function(ages) {
  if (ages < 18) {
    console.log(ages + ": Oh no, you can't vote quite yet.")
  } else {
    console.log(ages + ": Make sure you get out and vote!")
  }
})

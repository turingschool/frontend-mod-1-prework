...
var animals = ["Alligator", "Lizard", "Mosquito"];
...
var shoppingList = ["Bread Crumbs", "Grated Parmesan Cheese", "Dijon Mustard", "Dave's Rub", "Eggs", "Pork Chops"];
...
var hiTemps = [52, 70, 72];

for (var i = 0; i < hiTemps.length; i++) {
  console.log(2 * hiTemps[i]);
}

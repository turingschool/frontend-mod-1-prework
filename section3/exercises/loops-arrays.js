...
var animals = ["Tiger", "Cheetah", "Lion", "Bear", "Dolphin"]
...
var foods = ["Pasta", "Pizza", "Pretzel Nuggets", "Sweet Potato Fries"]
...
var numbers = [2, 10, 20, -10, 50, 2.5, 5.5]

for (var i = 0; i < numbers.length; i++) {
  result = numbers[i] * 2
  console.log(`${numbers[i]} doubled is ${result}`);
}

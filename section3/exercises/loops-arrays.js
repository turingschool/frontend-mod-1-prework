...
animals = ["Bat", "Piranha", "Chupacabra", "Narwhal"];

for (var i = 0; i < animals.length; i++) {
  console.log("The " + animals[i] + " is awaesome!");
}
...
var foods = ["Noodles", "Cereal", "Beans", "Cheese", "Cucumbers"];
...
var numList = [200, 175, 150, 125, 100, 75, 50, 25, 12.5];

for (var i = 0; i < numList.length; i++) {
  console.log(2 * numList[i]);
}
...
for (var i = 0; i < ages.length; i++) {
  ...
  } else console.log("Make sure you get out and vote!");
}

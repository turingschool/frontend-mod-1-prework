...
var myFavoriteAnimals = ["Snow Leopard", "Chinchilla", "Polar Bear", "Cat"]

for (var i = 0; i < myFavoriteAnimals.length; i++) {
  console.log(`The ${myFavoriteAnimals[i]} is awesome!`)
}
...
var myFavoriteFoods = ["Chocolate Gelato", "Noosa Yogurt", "Halva", "Mochi Icecream"];

for (var i = 0; i < myFavoriteFoods.length; i++) {
  console.log(`Add ${myFavoriteFoods[i]} to shopping list`);
}
...
var nums = [1 , 54,  69, 22, 43, 50.3, 99.9999999, 120, -87.39];

for (var i = 0; i < nums.length; i++) {
  console.log(`The number in this index doubled is ${nums[i] * 2}.`);
}

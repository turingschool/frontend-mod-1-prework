...
var moreAnimals = ["Lion", "Kangaroo", "Bear", "Hippogriff"];
...
var foodList = ["tortillas", "lettuce", "cheese", "tomato paste", "ground beef"]
var groceryList = [];
...
var intArray = [5, 10, 15, 20, 25];

for (var i = 0; i < intArray.length; i++) {
	console.log(intArray[i] * 2);
}
...
for (var i = 0; i < ages.length; i++) {
	var age = ages[i];
	if (age >= 18) {
		console.log(age, "Make sure you get out and vote!");
	} else {
		console.log(age, "Oh no, you can't vote quite yet.");
	}
}

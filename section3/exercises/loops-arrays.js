...
var foods = ["rice", "onions", "noodles"];
for (var i = 0; i < foods.length; i++){
  console.log("add ", foods[i], "to shopping list please");
}
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] < 18) {
    console.log("Your age: ", ages[i], ". It looks like you have ", (18 - ages[i]), "year until you can vote!");
  } else if (ages[i] <= 65) {
    console.log("Your age: ", ages[i], ". Only", 65 - ages[i], "more years until you can retire!")
  }
}

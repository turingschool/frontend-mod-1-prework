...
var coolAnimals = ['Pandas', 'Sloths', 'Foxes', 'Dogs'];

for (var i = 0; i < coolAnimals.length; i++) {
  console.log(coolAnimals[i] + " are awesome!");
}


// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var foods = ["Arugula", "Cherry toms", "Chickpeas", "Sweet potato"];
...
var numberArray = [4, 2, 1, 9, 1, 6, 3];

for (var i = 0; i < numberArray.length; i++) {
  console.log(numberArray[i] + " doubled is " + numberArray[i]*2);
}

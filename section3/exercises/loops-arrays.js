...
var numbers = [3, 535, 368, 92, .0942642624, 5113, 5]
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] < 18) {
    console.log("Oh no, you can't vote quite yet. Sorry :(");
  } else {
    console.log("Make sure you get out and vote, if politics are important to you!");
  }
}

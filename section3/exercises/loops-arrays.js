...
var foodNeeded = ["bread", "cheese", "eggs", "chips"];

for (var i = 0; i < foodNeeded.length; i++) {
  console.log("Add " + foodNeeded[i] + " to shopping list.");
}
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] < 18) {
    console.log("Oh no, you can't quit vote yet.")
  } else {

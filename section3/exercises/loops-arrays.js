...
var woodland = ["Squirrel", "Bunny", "Fox", "Owl"];

for (var i = 0; i < woodland.length; i++) {
  console.log(woodland[i]);
}
// YOU DO: Create an array of foods and then iterate over that array to log "Add
// <food> to shopping list" for each food item.
var shoppingList = ["melon", "pasta", "sourdough"];
...
for (var i = 0; i < ages.length; i++) {
  if (ages[i] < 18) {
    ...
    console.log("Make sure you get out there and vote!");
  }
}

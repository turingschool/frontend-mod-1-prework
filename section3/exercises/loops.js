...
// EXPLAIN: A list of numbers 1 through 3
/*That i is looped through until it is no longer less than 3 at increments increased by one.*/
...
for (var i=2+2; i <= 7; i++) {
 ...
 // 10 times.
for (var i = "She sells seashells down by the seashore"; i = 10; i++) {console.log(i);
}

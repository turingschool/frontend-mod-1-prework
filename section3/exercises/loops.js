...
// EXPLAIN: **the output is logging 0 three times and incrementing by 1 each time it is logged, thus the log returns 0,1,2.**
...
for (var i = 10; i >= 1; i--) {
 console.log(" This is a number loop: " + '' + [i] + '' );
}

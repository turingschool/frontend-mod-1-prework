...
/*The variable i is logged to the console to show that it is increasing by 1. Each time the condition i > 3 returns true, the number is logged until it reaches 3 and the
condition is returned false which will end the loop.*/

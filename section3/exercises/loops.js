...
1
2
will log to the console. The initial expression tells us where to start - at 0 index. The condition is as long as 'i' is less than 3. The update or increment expression tells us to run this code until the condition evaluates to false.
*/

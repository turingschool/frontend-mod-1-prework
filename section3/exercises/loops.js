...
// EXPLAIN:
/* The console logged: `012` as the `i` variable is set to 0 and also set to increment by 1 each time the code block runs;
 the condition was evaluating to false once i = 3, and that stopped the for loop. */

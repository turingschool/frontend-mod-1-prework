...
// EXPLAIN:
// 0, 1, 2 is logged into the console becuase it is printing the index number
//each time the loop executes, and each time that it does, the index number is increased

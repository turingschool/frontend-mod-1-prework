...
// EXPLAIN:
// [0, 1, 2] was logged to the console because we told the console to log (i) 3 times.
// i is short for index and is set as the loop variable. so when called 3 times it prints
// the index of 0, 1, 2.

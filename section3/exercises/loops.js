...
// EXPLAIN: The changing value of i is logged to the console as the script iterates through the loop. The integers 0,1,2 will log to the console. The value of i is changing because the statement i++ increments the value of i by 1 each time.

...
// EXPLAIN: The numbers 0, 1, and 2 are logged to the console, because the loop runs three times. In this case you are
//logging the value of the variable i to the console, which starts at 0 and adds 1 each time. Therefore the values are 1-3.

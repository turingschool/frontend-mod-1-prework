...
//The `i` variable is being logged each time the condition is true.
//The final part of the condition uses an increment operator on `i`
//Because of this, each time the loop runs the value of `i` increases
//Once `i` reaches 3 the loop stops because the condition is now false

...
// EXPLAIN:
// 0, 1, 2
// Because the code block is executed until the variable i reach the inmediate value less than 3 (which is 2), when the counter gets to
// 3 the condition evaluates to false and the code doesn't runs anymore.

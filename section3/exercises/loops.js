...
// EXPLAIN:
/* In the second example, the numbers 0, 1 and 2 are logged. This is because
the initialExpression is set to 0 and the code is set to run as long as i is less
than 3. Every time it runs, the counter increases by one, meaning that 0, 1 and 2
are the only numbers that could be displayed. */

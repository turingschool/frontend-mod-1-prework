...
// EXPLAIN:
//  -  with (i) as the statment to be logged to the console, it displays the value of `i`.
//  -  It displays that i = 0 + 0. then for the next time it calculates, it'll use the value of i = 1 + 0 to display 1 in teh console

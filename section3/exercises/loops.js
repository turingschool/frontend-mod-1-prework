...
/* The value of i is logged to the console, which in this case will be numbers
starting at 0 and incrementing by 1 until the value 3. This is because the i++
statement in the for loop means "increase the value of i by 1" every time the
loop runs. */

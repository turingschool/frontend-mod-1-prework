...
// EXPLAIN:
//0, 1, 2 is logged to the console.  Is 0 < 3?  True.  Write to page 0.  Is 1 < 3?  True.  Write to page 1.
//Is 2 < 3?  True.  Write to page 2.  The loop has run 3 times and 3 < 3 is false, so 0, 1, 2 are written
//to the console.

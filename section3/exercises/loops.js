...
// 1
// 2
// The index (i) keeps track of where you are in a loop. We set i to 0 so it starts at 0 and increases by one
// until it hits three. Because 3 is not less than 3 the loop stops running and it only log 0, 1, and 2.

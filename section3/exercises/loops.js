...
1
2
"i" starts at zero and after every iteration it is increased. the value of "i" is logged until it is equal to 3
*/
...
for (var i=0; i<7; i++) {
 ...
 // 10 times.
for (var i=0; i<10; i++) {
  console.log("She sells seasshells down by the seashore");
}

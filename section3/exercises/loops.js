...
// EXPLAIN:
// 0 1 2 is logged because the variable i is initialized at 0, so that is the first
// number logged. Each time the loop runs, i is increased by one. When i = 3, the
// condition i < 3 is not met, so the loop ends and 3 is not logged.

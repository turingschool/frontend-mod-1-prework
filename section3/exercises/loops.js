...
// EXPLAIN: The value of each index is logged to the console each time because
// no other value is declated, so the default value is i for index. ANd the initial expression tells
// us that the index begins at 0.

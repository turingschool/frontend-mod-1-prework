...
// EXPLAIN:
// The value of the index 'i' is logged to the console 3 times as the stopping index value is written as 'less than 3', which because it is the index number/position is represented as an increasing integer

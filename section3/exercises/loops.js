...
// EXPLAIN:
//012
//The variable i is set to 0, this is logged to the console per the code inside the curly braces.  Then the loops adds one to the counter, logs the variable.  Until i is not less than the 3.

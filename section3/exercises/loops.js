...
// EXPLAIN: 0 1 2 is logged to the console. This is because we assigned i to the value 0 and had i increase by while its value was less than 3. By logging i to the console we are able to see the increments each time we loop.

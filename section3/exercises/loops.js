...
// EXPLAIN:
// 0, 1, 2 will be logged. This is because i will log everytime it returns less than 3. We start at zero because i is set to start there. It will add one every loop and log until it reaches 3 then it will stop.

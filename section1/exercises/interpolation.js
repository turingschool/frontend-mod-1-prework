...
/* It will be a string data type consistening of a number and a name variable
The string will read My zoo has 7 unicorns! */
...
var awper = 'Apex'
var entry = 'Tarik'
console.log (`In a stunning fasion, ${entry} gets a double kill on ${pistol} and ${awper}!`)

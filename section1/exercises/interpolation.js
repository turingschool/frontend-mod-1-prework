...
Line 22 will log a string. Although there is a number variable inside the string,
Javascript helps us by converting the number into a string through "type coercion".
This allows the strings and numbers to combine together.

// YOU DO:
// Write code that combines the variables below into a string that
// reads "The quick red fox jumps over the lazy brown dog":

...
/* The data type logged into the console  will be a string because it is result of a
interpolations that combines variables between quotes.
*/
...
console.log(`The student ${firstName} ${lastName} is studing more than ${hoursOfStudy} hours per day!`);

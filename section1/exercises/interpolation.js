...
/*
A string will be logged to the console. By wrapping the values in `` you will
produce a string. The ${} simply allows you to add variables within the string.
*/
...
var drink = "coffee";
var numberOfCups = 3;
var favCoffee = "Iced Americano";

console.log(`I love ${drink} and I have ${numberOfCups} cups a day. My favorite is an ${favCoffee}.`);

...
console.log("I'm just a girl standing in front of her laundry");
...
what does the modules return?
-The remainder of when the two numbers are divided by each another
console.log(3 / 4);
not even
displays: 0.75

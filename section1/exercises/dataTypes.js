...
console.log("It's so easy to laugh, it's so easy to hate. It takes strength to be patient and kind.");
...
//My Comment: I did run this file in my terminal and it did pleasantly do all that I expected. 

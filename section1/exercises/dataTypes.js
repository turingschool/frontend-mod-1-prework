...
console.log("The past can't haunt me if I don't let it.");
...
// Did you run this file in your terminal to make sure everything printed out to the console
  ...
  // help ASAP.
  // The only place I ran into challenges is that there is a SyntaxError after 3
  // 3 is not equal to 4 and a ReferenceError that says Hello is not defined.

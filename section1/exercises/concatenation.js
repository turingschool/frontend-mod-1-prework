...
console.log("The " + speedy + " jumped over the " + slowPoke); // The quick red fox jumped over the lazy brown dog
...
var animalName = "Yoda";
var yodaAgeYears = 7;
console.log("I have a " + yodaAgeYears + " year old " + typeOfAnimal + " named " + animalName + "."); // I have a 7 year old cat named Yoda.

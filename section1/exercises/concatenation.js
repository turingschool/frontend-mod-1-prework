...
//String: type coercion turns number data type variable into a string so we can
//combine the two.
...
var subject = "elephant";
var object = "5 flamingos";
var verb = "touched";

console.log("The " + subject + " " + verb + " the " + object + ".");

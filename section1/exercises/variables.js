...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  //I used a string data type for the first variable because a name is comprised of letters, I used a boolean data type for the second variable becuase it is a question that can be answered with a true/false value, and I used integer for the third variable because the value is a whole number

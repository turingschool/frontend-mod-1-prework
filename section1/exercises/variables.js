...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  /* I recognized that I wanted my firstName to be seen in a string format since it is a set of characters, letters in this case. The IsHungry variable
  asks a yes/no question or seeks a true/false answer, so I used a boolean data type. Number of pets utilizes an integer format. */

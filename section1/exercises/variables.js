...
// log that variable to the console.
var person = 'Harry Potter must not return to Hogwarts!';
console.log(person);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
/* When deciding what data types to use in the above example, I first created the
variable structure and then reviewed the answer I gave.  From there I edited the
structure to reflect a strong, boolean and number types. */

...
// log that variable to the console.
var dobbySaid = "Harry Potter must not return to Hogwarts!"
console.log(dobbySaid);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  // I assessed whether a string, array, boolean or number was more appropriate based on the name of each variable.
  // The firstName variable stores names which are strings, the isHungry is a statement that can be answered by true/false, and the numberOfPets is a quantity.

...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
    // I assumed that first name would read as text, so I decided to use a string.
    // isHungry is sorta a true or false statement, so I used a boolean value.
    // numberOfPets is almost self-explanitory, and it should be answered as a number.

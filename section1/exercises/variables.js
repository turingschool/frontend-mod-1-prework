...
Each variable name has an implication of the data type they should be
- firstName implies a name, or string.
- isHungry implies like a yes or no question, i.e. a boolean value
- numberOfPets implies a numerical value, an integer in this case (hopefully not a float for this one)

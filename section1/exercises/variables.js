...
/*I assigned a string to the firstName variable because a name is represented with text.
I assigned a boolean value to the isHungry variable because you are either hungry (true) or not (false).
I assigned a number value to the numberOfPets because it is just a number.*/

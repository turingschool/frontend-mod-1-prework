...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
/*The name of a variable should reflect the type of information that it's going to store. The data type
chosen was based on the variable name as a clue to the data type. firstName is obvious, stored my own name.
isHungry only has a yes/no response, so the data type I used was Boolean data - true or false. numberOfPets tells me the
data type will be a number.*/

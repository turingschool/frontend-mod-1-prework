...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// firstName should be a string because it requires an answer that should be unchanged.
/* isHungry fits best with a boolean because it can be a true or false statement and can change
base on time of day*/
// numberOfPets must be an integer because because it requires a number.

...
// log that variable to the console.
var sentence = `${name} must not return to Hogwarts!`;
var sentence2 = name + " must not return to Hogwarts!"
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//firstName is a string because it is one or more words
//isHungry is a boolean because the answer is either true or false
//numberOfPets is an integer because it is a number that is not a decimal

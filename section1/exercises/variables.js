...
// log that variable to the console.
var string1 = 'Harry Potter must not return to Hogwarts!';
console.log(string1);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// I knew to use a string for the first one, because it's a single word.
// I knew to use a boolean for the second one, because it's a true/false statement.
// I knew to use an array for the second one, because it's a list.

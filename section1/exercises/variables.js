...
// log that variable to the console.
var returningStudents = "Harry Potter must not return to Hogwarts!";
console.log(returningStudents);
...
/* ANSWER: I chose a string data type for firstName because it seems apropriate to use a word.
I chose a boolean data type for isHungry because a simple bianary response seems like the best option.
I chose a number data type for numberOfPets because it is somthing that is counted.*/

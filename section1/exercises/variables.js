...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
    /*for first name I used a string because all the other date types a name wouldn't work.
     for is hungry i used a boolean because its asking a true or false statement.
     with a number of pets its looking for an intiger so i used a number data type*/

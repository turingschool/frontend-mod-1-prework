...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
For firstName you define a name, which is a strong
For isHungry the value is either true or false so this is a boolean
numberOfPets is a simple number so an integer
// YOU DO:

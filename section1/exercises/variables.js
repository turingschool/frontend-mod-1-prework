...
// log that variable to the console.
var harryString = "Harry Potter must not return to Hogwarts!";
console.log(harryString);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//  For firstName I used string because it is just listing off someones name.
//  For isHungry I used boolean because it is either a true or false variable.
//  For numberOfPets I used integer because its how many pets that person has, and that cannot be a float.

...
// log that variable to the console.
var order = "Harry Potter must not return to Hogwarts!";
console.log(order);
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  //The firstName variable refers to a name, which is a collection of letters, so I used the string data type.
  //isHungry is a yes/no or true/false boolean data type, so I defined it as boolean (and true at the moment).
  //numberOfPets is a count, or a number, so I used the integer data type.

...
// log that variable to the console.
var sentance = "Harry Potter must not return to Hogwarts!";
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//firstName implies that a string variable will be stored. isHungry can be answered using true/false so that makes it a boolean. numberOfPets is asking for a number variable, making it an integer/number.

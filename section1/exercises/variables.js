...
// log that variable to the console.
var noReturn = "Harry Potter must not return to Hogwarts!"
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain. I used a string for the first name variable as this would be best represented as text. For isHungry I used a boolean as this was a yes or no type questions and the numberOfPets I used a number as the total should be a quantity.

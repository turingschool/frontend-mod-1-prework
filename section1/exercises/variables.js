...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
    // I used a string for my name since it was plain text.
    // I used a boolean for if I'm hungry, because it's either true or not.
    // I used a number for number of pets, since it's something to be counted.

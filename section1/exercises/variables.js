...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
console.log("Names are just text, so I used a string. The variable name isHungry suggests that the result should be either true or false. Finally, numberOfPets is clearly calling for a number. :)");

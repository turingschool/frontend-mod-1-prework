...
// log that variable to the console.
var cancelHarry = "Harry Potter must not return to Hogwarts!"
console.log(cancelHarry)
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  // The variable names were intuitive in what kind of value it expected.
    // names are usually strings, isVerb will usually be a boolean, and the word number in the varible is likely to be a number value

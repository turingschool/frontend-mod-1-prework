...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// First name is a person's name, so that's a string.  Is hungry is a yes or no question, so that's a boolean. Number of pets is a number, an integer in particular. //

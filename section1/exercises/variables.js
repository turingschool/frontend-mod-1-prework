...
// firstName is a word (my name)  it is a data type that represents text. Making it a string varible.
// isHungry is a true or false answer, it is a BOOLEANS
// numberOfPets is an numberical amount so it would be an integer

...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
  // The firstName variable asked for my name, so I knew that would be a string. The second was formatted to give either a true or false answer, which is a boolean. The third requests a quantity, which is a number data type.

...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// I used a string for `firstName` because names are composed of letters. I used boolean for 'isHungry' because the it's a yes or no. And I used a number for 'numberOfPets' because, by its name, it indicates a number is required, although you could also write the number as a string (e.g., 'six').

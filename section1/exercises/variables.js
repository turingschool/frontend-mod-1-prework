...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain. Strings display text, which can represent firstName.  isHungry is a binary condition
  //that can either be true for false, which makes a boolean data type appropriate.  Lasty, numberOfPets
  //requires a number; though it could be written out in text as well, an integer is more efficient.

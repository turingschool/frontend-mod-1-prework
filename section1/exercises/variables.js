...
// log that variable to the console.
var noReturn = name + " must not return to Hogwarts!";
...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
//I based my decision for what data type to use based off of what was implied by the names of each variable.

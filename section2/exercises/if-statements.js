...
for yourself!
I utilized a logical operator (&& - logical AND) for the last excersise to evaluate if both variables
were true the code to execute "I can make pizza" would be logged. I used || (logical OR) to evaluate
if either of the variables were not met or false, the code to be executed would be "I cannot make pizza".
*/

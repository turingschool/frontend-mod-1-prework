...
I used a logical operator for the last question. I used the AND operator. Looking
back the second to last one could use the OR by saying if numQuarter =0 || numquarter = 1
then you youwould achieve "I don't have enough money for a gumball"

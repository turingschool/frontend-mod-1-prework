...
} else if (numQuarters === 2 || numQuarters > 2) {
  console.log("I have enough money for a gumball");
} else{
  console.log("I don't like gumballs anyway");
}
...
if (cupsOfFlour === 1 && hasSauce === true) {
  ...
  console.log("sorry, you can't bake"); //block of code to be executed if the condition is false.
}

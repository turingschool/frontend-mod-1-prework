...
if (cupsOfFlour >= 2 && hasSauce) {
 console.log('I can make pizza! Bon apetit!');
} else {
  console.log("I cannot make a pizza. Go get some ingredients from King Sooper's!");
}
...
Yes, they both did. The logical operators in JavaScript include && (and), || (or),
and !(not). They're pretty nifty, and useful. I want to get to know them and make some
cool code happen.
*/

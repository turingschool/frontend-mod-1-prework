...
//alternatively, you can get the same conditon with this.
if (dogAge <= 2) {
  console.log ('puppy');
} else if (dogAge >= 10) {
  console.log('elderly');
...
My examples did not use logical operators. Those are &&, ||, and !. I tried to work
with these but couldn't get the outcome I wanted so I assumed they weren't the
right operators for the equation.
*/

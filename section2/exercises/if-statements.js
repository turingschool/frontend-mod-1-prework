...
if (numQuarters >= 2) {
  msg = "I have enough money for a gumball.";
} else {
	msg = "I don't have enough money for a gumball.";
}
...
if ((cupsOfFlour >= 2) && hasSauce) {
	msg = "I can make a pizza.";
} else {
	msg = "I cannot make a pizza.";
}

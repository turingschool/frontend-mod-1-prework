...
// EXAMPLE: Manipulate the variable 'weather' to see if you can print something other than 'coat'.
...
// While working through this example, I would toggle which variable declaration is commented in/out and run the program in node several times to observe the output.
...
/*
YOU DO:
Using the dogAge variable defined below, determine if a dog is a puppy (2 or younger), an adult, or elderly (10 or older).
...
/*
YOU DO:
Using the numQuarters variable defined below, determine if you have enough money to buy a gumball. A gumball costs two quarters. Right now, the program will log out both 'I have enough money for a gumball' and 'I don't have enough money for a gumball'. Write a conditional statement that ONLY logs one or the other.
...
/*
YOU DO:
Using the variables defined below, determine if you have the ingredients to make a pizza. A pizza requires at least two cups of flour and sauce.

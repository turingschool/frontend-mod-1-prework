...
I think that the last one needed one but I can't see why the gumball one would. The && was
useful because I need both hasSauce to be true and cupsOfFlour to be greater than 2 to make
pizza. Logical operators like and (&&) and or (||) help us when we need two coniditions at
the same time in an if statement.

...
The logical operators we learned about were the && and the ||. They perform logic based actions. In the directions to this exercise it asks for two conditions to both be met for true to occur. The AND logical operator allows for this to occur in that both of the conditions in the AND have to be met for true to result (The 1 cup flour and the no sauce thus yields a false).

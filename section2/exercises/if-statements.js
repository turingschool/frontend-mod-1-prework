...
I only used a logical operator for the last exercise to help evaluate two variables
in the condition. I could not find a reason to use a logical operator for the
2nd to last exercise.
*/

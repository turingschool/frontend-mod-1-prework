...
for yourself!
I did not use logical operators untill, I came upon the pizza problem.
During the gumball problem we can use a simple if else script to correctly detect if we have enough money.
However since we have a more complex if else statement with our pizza problem, I began to use logical operators to get proper true or false booleans.
*/

...
My solutions did use a logical operator - I had to use Google to find the convention for combining comparative statements.
Then I made another Google search after I got an "Error: Unexpected token '&&'", which revealed that another set of parentheses
was necessary to complete the convention for combining comparative statements.

...
if (dogAge <= 2) {
  console.log("This dog is a puppy. Awwwww, so cute!");
} else if (dogAge < 10) {
  console.log("This is an adult dog. Give them belly scratches.");
} else {
  console.log("This is an elderly dog. My favorite! Give them a happy, forever home.");
}

...
if (dogAge <= 2) {
  console.log('This dog is a Pupper!')
} else if (dogAge <= 9) {
  console.log('This dog is an adult.')
} else if (dogAge >= 10) {
  console.log('This is one elderly dog!')
} else{
  console.log('What a fine looking doggy!')
}
...
console.log("I don't have enough money for a gumball");
  ...
  console.log('You need 2 quarters to buy a gumball.');
}
...
I did not think to use a logical operator in the last two exercises! A logical operator can return a boolean value for a set of true/false statements. I could have used the && value for the pizza problem because I would need both the flower and the sauce.
*/

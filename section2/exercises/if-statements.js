...
I was able to use a logical operator for the last exercise. Because 2 conditions needed to be met,
this was an ideal time for the && command. This tells the conditional that both "cupsOfFlour >= 2"
and "hasSauce === true" must be true to meet the first condition ("I can make pizza").

...
if (dogAge <= 2) {
  console.log('It is a puppy puppy!!');
} else if (dogAge >= 10) {
  console.log('It is an elderly puppy!');
} else {
  console.log('It is an adult puppy!');
}
...
for yourself!
logical operators are symbols or words used to connect two or more expressions, assessing depening on the meaning of the operator.
*/

...
if(cupsOfFlour === 2 && hasSauce = true) {
  ...
  consolelog.("I cannot make pizza")
} else
  console.log("I don't even like pizza");
/*
For the last two exercises, an ideal solution probably uses a logical operator.
Did yours? Do you know what a logical operator in JavaScript is? Google it to answer
for yourself!

My last exercise used a logical operator but I didn't use one on the gumball example
because there was only one variable. A logical operator in JavaScript uses boolean logic to
return the value true or false and is represented by && (And)or || (OR).

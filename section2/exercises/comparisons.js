...
// ANSWER:
// I assumed that the cut off age for a puppy was 1 years old. Using that information I used a comparison operator to ask if the value of
// age was less than or equal to 1, and I used the logical operator `&&` to see if the dog was a puppy AND loves to play.

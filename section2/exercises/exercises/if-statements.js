...
for yourself!  Yes, each of my last two statements use logical operators.  A logical operator is one that
allows for two or more conditions to be checked.  They're as follows: And operator (&&; all conditions must
be true) and Or operator (||; at least one condition must be true).

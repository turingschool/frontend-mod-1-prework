...
I did not use a logical operator but I can see how that might be an ideal soution
The soution I coded used a relational operator after the initial assignment operators to determine the correct output.
I can now see that a different way to think about this using logical operators would look quite different and have a simpler flow:
```

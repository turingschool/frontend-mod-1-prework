...
for yourself! A logical operator is the && or ||. The && operator means that both conditions on either side of the operand need to be true in order for the condition to be met. The || means that either of the conditions need to be true in order the condition to be met. My solution did make use of the && operator.

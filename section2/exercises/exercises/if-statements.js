...
if (dogAge <= 2) {
  ...
  console.log('Well this is not supposed to happen');
}
/*
YOU DO:
...
for yourself! My last exercise used a logical operator, my second to last one seemed more efective to use comparison operators.

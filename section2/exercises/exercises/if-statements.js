...
if (dogAge <= 2) {
  console.log ("This little one is less than 2, which makes them a puppy.");
}
else if (dogAge >= 10) {
  console.log("This dignified pupper is older than 10, which makes them elderly.")
}
else {
  console.log("This doggo is older than 2 and less than 10, which makes them an adult.")
}
...
if ((cupsOfFlour >= 2) && (hasSauce = true)) {
  ...
  console.log("I don't have the ingredients to make pizza :(");
}
...
I don't see how the gumball example would benefit from a logical operator. I posted to the team slack and I'm going to move on for now. 

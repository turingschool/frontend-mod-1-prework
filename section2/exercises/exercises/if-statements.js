...
if (dogAge <=2) {
  console.log("That's a puppy!");

} else if (dogAge >= 10) {
  console.log("That's an elderly dog!");

} else {
  console.log("That's an adult dog!");
}
...
for yourself!
I don't think a logical operator could have been used in the second to last excercise
but the last one does! I didn't use one at first but went back and changed it to be
better! A logical statement would be using one of these: || && !

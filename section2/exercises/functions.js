...
EXPLAIN: I named the function `makeSentence` because it serves to make a sentence out of any two words passed in as arguments. I named the parameters `singNoun` for 'singular noun' and `directObj` for 'direct object' to indicate the preferrred types of words in order for the output to make sense.
*/
